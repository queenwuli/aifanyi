        ...
        if(el) {
            ...
            if(main) {
                main.insertAdjacentHTML(
                    'beforeend',
                    `<span id="aitansLoading" style="font-size:14px;position:absolute;z-index:999;left:0;right: 0;padding: 5px 10px;margin: 0 auto;border-radius: 4px;text-align:center;bottom:0;color:${color};">${txt}</span>`
                );
            };
        }
    }
